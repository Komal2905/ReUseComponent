...
public class TimelineView: UIView {
	...
	*/
	public var lineColor: UIColor = UIColor.blueColor(){ //$$lightGrayColor
		didSet{
			setupContent()
		}
	}
...
//            
//            
//          // testingIndex = timeFrames.indexOf(element.image)
//            print("testingIndex",testingIndex)
...
//		}
        ...
        for var index in 0...timeFrames.count - 1
        {
            ...
            let v = blockForTimeFrame(timeFrames[index], imageTag: i)
//            if(index%2 == 0)
//            {
//                
//                v.backgroundColor = UIColor.redColor()  // $$$ Delte
//
//            }
//            else
//            {
//                v.backgroundColor = UIColor.yellowColor()  // $$$ Delte
//                
//            }
            
            addSubview(v)
            addConstraints([
                NSLayoutConstraint(item: v, attribute: .Top, relatedBy: .Equal, toItem: viewFromAbove, attribute: .Bottom, multiplier: 1.0, constant: 0), // $$$0
                NSLayoutConstraint(item: v, attribute: .Width, relatedBy: .Equal, toItem: viewFromAbove, attribute: .Width, multiplier: 1.0, constant: 0),
                ])
            if showBulletOnRight{
                addConstraint(NSLayoutConstraint(item: v, attribute: .Right, relatedBy: .Equal, toItem: viewFromAbove, attribute: .Right, multiplier: 1.0, constant: 0))
...
//		line.backgroundColor = lineColor $$
        ...
        line.backgroundColor = timeFrames[2].testColor
		addSubview(line)
		...
		addConstraints([
			...
			NSLayoutConstraint(item: line, attribute: .Top, relatedBy: .Equal, toItem: viewFromAbove, attribute: .Bottom, multiplier: 1.0, constant: 0),//0
		...
		addConstraint(NSLayoutConstraint(item: viewFromAbove, attribute: .Bottom, relatedBy: .Equal, toItem: self, attribute: .Bottom, multiplier: 1.0, constant: 0))//0
	}

    private func bulletView(size: CGSize, bulletType: BulletType, fillColor : UIColor, lineColor : UIColor) -> UIView {
	...
	private func blockForTimeFrame(element: TimeFrame, imageTag: Int) -> UIView{
        ...
        var filleColortest = UIColor()
        
        if(testingIndex == 3)
        {
            filleColortest = UIColor(red: 76/255, green: 175/255, blue: 80/255, alpha: 1.0)
            
            bullet = bulletView(s, bulletType: bulletType,fillColor : filleColortest,lineColor: filleColortest)
        }
        else
        {
            if(testingIndex > 3){
                filleColortest = UIColor.grayColor()
                
                bullet = bulletView(s, bulletType: bulletType,fillColor : filleColortest,lineColor: UIColor.grayColor())
            }
            else
            {
            filleColortest = UIColor.blackColor()
            
            bullet = bulletView(s, bulletType: bulletType,fillColor : filleColortest,lineColor: UIColor.blackColor())
            }
            
        }
        
        
        //let bullet: UIView = bulletView(s, bulletType: bulletType,fillColor : filleColortest)$$
		v.addSubview(bullet)
		v.addConstraint(NSLayoutConstraint(item: bullet, attribute: .Top, relatedBy: .Equal, toItem: v, attribute: .Top, multiplier: 1.0, constant: 0))//0
		if showBulletOnRight{
		...
		v.addConstraints([
			...
			NSLayoutConstraint(item: titleLabel, attribute: .Top, relatedBy: .Equal, toItem: v, attribute: .Top, multiplier: 1.0, constant: -2)//-5
			])
		if showBulletOnRight{
		...
		v.addConstraints([
			...
			NSLayoutConstraint(item: textLabel, attribute: .Top, relatedBy: .Equal, toItem: titleLabel, attribute: .Bottom, multiplier: 1.0, constant: 5),//5
            
            // added by komal
            

//            NSLayoutConstraint(item: textLabel, attribute: .Bottom, relatedBy: .Equal, toItem: v, attribute: .Bottom, multiplier: 1.0, constant: 5),//5
			])
		if showBulletOnRight{
...
//			backgroundViewForImage.backgroundColor = UIColor.blackColor()
            ...
            backgroundViewForImage.backgroundColor = UIColor.lightGrayColor()
			backgroundViewForImage.layer.cornerRadius = 10
			v.addSubview(backgroundViewForImage)
			v.addConstraints([
				NSLayoutConstraint(item: backgroundViewForImage, attribute: .Width, relatedBy: .Equal, toItem: v, attribute: .Width, multiplier: 1.0, constant: -60),//-60
				//NSLayoutConstraint(item: backgroundViewForImage, attribute: .Height, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: 20),//130 $$$ uncommet
                
                NSLayoutConstraint(item: backgroundViewForImage, attribute: .Height, relatedBy: .Equal, toItem: backgroundViewForImage, attribute: .Width, multiplier: 1.0, constant: 0),//130komal // comment if ImagevIew is not proper
				...
				NSLayoutConstraint(item: backgroundViewForImage, attribute: .Bottom, relatedBy: .Equal, toItem: v, attribute: .Bottom, multiplier: 1.0, constant: -20) // -10 $$unc
				])
			if showBulletOnRight{
            ...
            print("backgroundViewForImage Farne",v.bounds)
...
//            let image1 = image
//            
//            let size = CGSizeApplyAffineTransform(image1.size, CGAffineTransformMakeScale(0.5, 0.5))
//            let hasAlpha = false
...
//            UIGraphicsEndImageContext()
			...
			let imageView = UIImageView(image: image) /// $$ ORIGINAL
...
//            case ScaleAspectFill
			imageView.contentMode = UIViewContentMode.ScaleToFill//ScaleAspectFit//ScaleAspectFill//ScaleAspectFit
            
            
			v.addSubview(imageView)
			imageView.tag = imageTag
			v.addConstraints([
				NSLayoutConstraint(item: imageView, attribute: .Left, relatedBy: .Equal, toItem: backgroundViewForImage, attribute: .Left, multiplier: 1.0, constant: 10),
				NSLayoutConstraint(item: imageView, attribute: .Right, relatedBy: .Equal, toItem: backgroundViewForImage, attribute: .Right, multiplier: 1.0, constant: -10),
				NSLayoutConstraint(item: imageView, attribute: .Top, relatedBy: .Equal, toItem: backgroundViewForImage, attribute: .Top, multiplier: 1.0, constant: 10),
				NSLayoutConstraint(item: imageView, attribute: .Bottom, relatedBy: .Equal, toItem: backgroundViewForImage, attribute: .Bottom, multiplier: 1.0, constant: -10)
				])
            
            
            
            print("imageView Farne",imageView.frame)
            
            // Upper all 0 insted of 10
...
//		sendSubviewToBack(line)
        ...
        if(testingIndex == 3)
        {
            lineColor = UIColor(red: 76/255, green: 175/255, blue: 80/255, alpha: 1.0)
        ...
        if(testingIndex == timeFrames.count - 1)
        {
		...
		v.addConstraints([
			NSLayoutConstraint(item: line, attribute: .Width, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: 2),
